#!/bin/bash
# This script installs basic configuration for bspwm and related tools on Arch Linux.

echo "Installing the packages..."
sudo pacman -Syu || { echo "Error: pacman -Syu failed. Exiting."; exit 1; }
sudo pacman -S bspwm sxhkd picom polybar rofi alacritty || { echo "Error: Package installation failed. Exiting."; exit 1; }
