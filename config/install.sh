#!/bin/bash
# This script installs basic configuration for bspwm and related tools.

echo "Installing the packages..."
sudo zypper refresh || { echo "Error: zypper refresh failed. Exiting."; exit 1; }
sudo zypper in bspwm sxhkd picom polybar rofi alacritty || { echo "Error: Package installation failed. Exiting."; exit 1; }
